...
public class MessageRequest {
    ...
    //enums
    public enum Source{
        R1, R2, R3, W1_POS1, W1_POS2 , W1_POS3, SIMULATOR
    }
    ...
    public enum Command{
        ...
        SUBASS1,SUBASS1_COMPLETED,  	//pos1
        SUB1_COMPLETED,SUBASS2,SUBASS2_COMPLETED,  	//pos2
        SUB2_COMPLETED,SUBASS3,   	//pos3
    ...
    //Constructor
    public MessageRequest(Source source, Target target , Command command) {
        this.source = source;
        this.target = target;
