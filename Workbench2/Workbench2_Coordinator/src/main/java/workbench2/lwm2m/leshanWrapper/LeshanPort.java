...
public class LeshanPort {
  ...
  public static void execute(LeshanExecuteIf e) throws InterruptedException {
    execute(e, String.format("{ \"sender\": \"SERVER\", \"receiver\": \"ROBOT\", \"timestamp\": \"%s\"}", new Timestamp(System.currentTimeMillis())));
  }

  public static void execute(LeshanExecuteIf e, String arguments) throws InterruptedException {
  ...
  protected static <T extends LwM2mResponse> T sendRequest(AbstractDownlinkRequest<T> request)
