...
public class RobotInstance extends BaseInstanceEnabler {
    ...
    public static Robot2Ctrl robot2Ctrl;
    public static SignalDetector signaldetect;
    public RobotInstance(final Robot2Ctrl robot2Ctrl , String endpoint) {
    	this.robot2Ctrl =robot2Ctrl;
    	signaldetect = new SignalDetector(robot2Ctrl.itsMsgQ);
    	 //new Thread(robot2Ctrl).start();
